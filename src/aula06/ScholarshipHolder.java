...
public class ScholarshipHolder extends Student {
    ...
    public ScholarshipHolder(String name, int cc, DateYMD birthDate, DateYMD enrollmentDate,
        Teacher supervisor,
    ...
    public ScholarshipHolder(String name, int cc, DateYMD birthDate, Teacher supervisor,
        int scholarshipValue) {
